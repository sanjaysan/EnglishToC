...
public class EnterSentence extends JFrame {
    ...
    public void finish()
    {
        ...
        try
        {
            ...
            if(choice==1)
            {
                func=readFile("sortfiles/insertionsort.txt");
                bw.write(func);
            ...
            {
                func=readFile("sortfiles/bubblesort.txt");
                bw.write(func);
                bw.write("int main()"+nl+"{"+nl+"int i,n;"+nl+"int a[1000];"+nl+"scanf(\"%d\",&n);"+nl);
            ...
            {
                func=readFile("sortfiles/heapsort.txt");
                bw.write(func);
                bw.write("int main()"+nl+"{"+nl+"int i,n;"+nl+"int a[1000];"+nl+"scanf(\"%d\",&n);"+nl);
            ...
            {
                func=readFile("sortfiles/mergesort.txt");
                bw.write(func);
                bw.write("int main()"+nl+"{"+nl+"int i,n;"+nl+"int a[1000];"+nl+"scanf(\"%d\",&n);"+nl);
            ...
            {
                func=readFile("sortfiles/quicksort.txt");
                bw.write(func);
                bw.write("int main()"+nl+"{"+nl+"int i,n;"+nl+"int a[1000];"+nl+"scanf(\"%d\",&n);"+nl);
            ...
            {
                func=readFile("sortfiles/countsort.txt");
                bw.write(func);
                bw.write("int main()"+nl+"{"+nl+"int i,n;"+nl+"int a[1000];"+nl+"scanf(\"%d\",&n);"+nl);
    ...
    public void input(String subString) throws IOException
    {
        ...
        else
        {
            ...
            if(subString.contains("integer")||subString.contains("numbers")||subString.contains("int")&&!subString.contains("print")&&!subString.contains("floating point"))
            {
    ...
    public void arithmeticOperations(String arithmeticStr)throws IOException
    {
        ...
        ||arithmeticStr.contains("number")||arithmeticStr.contains("numbers"))
        ...
        for(int i=1;i<=numStr;i++)
        {
            if(arithmeticStr.contains("integers")||arithmeticStr.contains("integer") || arithmeticStr.contains("number")
                    || arithmeticStr.contains("numbers"))
            {
    ...
    public void sort(String subString)
    {
        ...
        jcb.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                try
                {
                    BufferedWriter output = new BufferedWriter(new FileWriter(new File("outputs/output.txt")));
                    output.flush();
                    output.close();
                }
    ...
    public EnterSentence() throws IOException {
        ...
        //    headers=readFile("outputs/headers.txt");
